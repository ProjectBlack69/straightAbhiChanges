...
document.addEventListener("DOMContentLoaded", () => {
 ...
 // List of image URLs
 const heroImages = [
    '../../static/assets/hero-image.jpg',
    '../../static/assets/destination1.jpeg',
    '../../static/assets/destination2.jpeg',
    '../../static/assets/destination3.jpeg'
  ];
  ...
  function changeHeroImage() {
    ...
    currentIndex = (currentIndex + 1) % heroImages.length; // Loop back to the first image after the last one
  }
